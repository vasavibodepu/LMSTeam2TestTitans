...
public class AssignmentSteps {
	...
	public void admin_should_see_search_bar_on_the_manage_assignment_page() {
		assignmentPage.searchBarAssignmentPage();
...
//	Assignment details Popup window verification
	...
	public void admin_should_see_a_popup_with_heading(String headerPopUp) {
		Boolean actualtext = assignmentPage.assignWindowPopUp();
...
//    @NewAssignment
	...
	public void admin_is_on_assignment_details_popup_window() {
		...
		assignmentPage.assignWindowPopUp();
	}
	...
	@When("Admin enters values in all fields with invalid data from {string} and {string} and clicks save button on add assignment page")
	public void admin_enters_values_in_all_fields_with_invalid_data_from_and_and_clicks_save_button_on_add_assignment_page(
			String string, String string2) {

	}

	@Then("Error message should appear in alert on add assignment page")
	public void error_message_should_appear_in_alert_on_add_assignment_page() {

	}

	@When("Admin enters data from {string} and {string} missing value in program name and clicks save button on add assignment page")
	public void admin_enters_data_from_and_missing_value_in_program_name_and_clicks_save_button_on_add_assignment_page(
			String string, String string2) {

	}

	@Then("Program Name is missing on add assignment page")
	public void program_name_is_missing_on_add_assignment_page() {

	}

	@When("Admin enters data from {string} and {string} missing value in Batch number and clicks save button")
	public void admin_enters_data_from_and_missing_value_in_batch_number_and_clicks_save_button(String string,
			String string2) {

	}

	@Then("Batch number is missing on add assignment page")
	public void batch_number_is_missing_on_add_assignment_page() {

	}

	@When("Admin enters data from {string} and {string} missing value in Assignment name and clicks save button")
	public void admin_enters_data_from_and_missing_value_in_assignment_name_and_clicks_save_button(String string,
			String string2) {

	}

	@Then("Assignment name is missing on add assignment page")
	public void assignment_name_is_missing_on_add_assignment_page() {

	}

	@When("Admin enters data from {string} and {string} missing value in Assignment due date and clicks save button on add assignment page")
	public void admin_enters_data_from_and_missing_value_in_assignment_due_date_and_clicks_save_button_on_add_assignment_page(
			String string, String string2) {

	}

	@Then("Assignment due date is missing on add assignment page")
	public void assignment_due_date_is_missing_on_add_assignment_page() {

	}

	@When("Admin enters data from {string} and {string} missing value in grade by and clicks save button")
	public void admin_enters_data_from_and_missing_value_in_grade_by_and_clicks_save_button(String string,
			String string2) {

	}

	@Then("Grade by is missing on add assignment page")
	public void grade_by_is_missing_on_add_assignment_page() {

	}

	@When("Admin enters passed date in the due date field and clicks save button on add assignment page")
	public void admin_enters_passed_date_in_the_due_date_field_and_clicks_save_button_on_add_assignment_page() {

	}

	@Then("Assignment cannot be created for the passed date on add assignment page")
	public void assignment_cannot_be_created_for_the_passed_date_on_add_assignment_page() {

	}

	@When("Admin clicks date from date picker on add assignment page")
	public void admin_clicks_date_from_date_picker_on_add_assignment_page() {

	}

	@Then("selected date should be their in class date text box on add assignment page")
	public void selected_date_should_be_their_in_class_date_text_box_on_add_assignment_page() {
		// Assert.assertEquals("Current date is not highlighted in the date picker",
		// formattedCurrentDate, dateInDatePicker);

		LoggerLoad.error("Date is not selected in assignment");
	}

	@Then("selected date should be in  {string} format on add assignment page")
	public void selected_date_should_be_in_format_on_add_assignment_page(String string) {

	}

	@When("Admin clicks right arrow in the date picker near month on add assignment page")
	public void admin_clicks_right_arrow_in_the_date_picker_near_month_on_add_assignment_page() {

	}

	@Then("Next month calender should visible on add assignment page")
	public void next_month_calender_should_visible_on_add_assignment_page() {

	}

	@When("Admin clicks left arrow in the date picker near month on add assignment page")
	public void admin_clicks_left_arrow_in_the_date_picker_near_month_on_add_assignment_page() {
	...
	@When("Admin clicks date picker button on add assignment page")
	public void admin_clicks_date_picker_button_on_add_assignment_page() {

	}

	@Then("Admin should see current date is highled in the date picker on add assignment page")
	public void admin_should_see_current_date_is_highled_in_the_date_picker_on_add_assignment_page() {

	}

	@When("Admin clicks date picker button and selects future date on add assignment page")
	public void admin_clicks_date_picker_button_and_selects_future_date_on_add_assignment_page() {
	...
	@When("Admin clicks Cancel button without entering values in the fields on add assignment page")
	public void admin_clicks_cancel_button_without_entering_values_in_the_fields_on_add_assignment_page() {
	...
	@When("Admin clicks Cancel button entering values in the fields on add assignment page")
	public void admin_clicks_cancel_button_entering_values_in_the_fields_on_add_assignment_page() {

	}

	@Then("Admin should land on manage assignment Page and validate new assignment is not created in the data table")
	public void admin_should_land_on_manage_assignment_page_and_validate_new_assignment_is_not_created() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
// Edit assignment
	...
	public void admin_clicks_edit_button_in_data_table_for_assignment_page() {
	...
	public void admin_clicks_edit_button_from_one_of_the_row_in_data_table_for_assignment_page() {

	}

	@Then("Edit popup window appears with same row values in the all fields for assignment page")
	public void edit_popup_window_appears_with_same_row_values_in_the_all_fields_for_assignment_page() {

	}

	@Given("Admin is in  Edit assignment detail popup window clicks Edit button in manage assignment")
	public void admin_is_in_edit_assignment_detail_popup_window_clicks_edit_button() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}

	@When("Admin enters all mandatory field values with valid data from {string} and {string} and clicks save button on edit assignment page")
	public void admin_enters_all_mandatory_field_values_with_valid_data_from_and_and_clicks_save_button_on_edit_assignment_page(
			String string, String string2) {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	public void admin_should_see_updated_assignment_details_is_added_in_the_data_table_for_assignment_page() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}

	@When("Admin enters all mandatory field values with invalid data from {string} and {string} and clicks save button on edit assignment page")
	public void admin_enters_all_mandatory_field_values_with_invalid_data_from_and_and_clicks_save_button_on_edit_assignment_page(
			String string, String string2) {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	public void error_message_should_appear_in_alert_on_edit_assignment_page() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}

	@When("Admin enters values in all fields with valid data from {string} and {string} and clicks save button on edit assignment page")
	public void admin_enters_values_in_all_fields_with_valid_data_from_and_and_clicks_save_button_on_edit_assignment_page(
			String string, String string2) {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}

	@When("Admin enters with invalid data in optional fields from {string} and {string} and clicks save button on edit assignment page")
	public void admin_enters_with_invalid_data_in_optional_fields_from_and_and_clicks_save_button_on_edit_assignment_page(
			String string, String string2) {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	public void error_message_should_appear_in_alert_for_assignment_page() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}

	@When("Admin enters  data missing value in program name from {string} and {string} and clicks save button on edit assignment page")
	public void admin_enters_data_missing_value_in_program_name_from_and_and_clicks_save_button_on_edit_assignment_page(
			String string, String string2) {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	public void program_name_is_missing_for_assignment_page() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	@When("Admin enters data missing value in Batch number from {string} and {string} and clicks save button on edit assignment page")
	public void admin_enters_data_missing_value_in_batch_number_from_and_and_clicks_save_button_on_edit_assignment_page(
			String string, String string2) {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	public void batch_number_is_missing_for_assignment_page() {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}

	@When("Admin enters data missing value in Assignment name from {string} and {string} and clicks save button on edit assignment page")
	public void admin_enters_data_missing_value_in_assignment_name_from_and_and_clicks_save_button_on_edit_assignment_page(
			String string, String string2) {
		// Write code here that turns the phrase above into concrete actions
		throw new io.cucumber.java.PendingException();
	}
	...
	public void assignment_name_is_missing_for_assignment_page() {
	}

	@When("Admin enters data missing value in Assignment due date from {string} and {string} and clicks save button on edit assignment page")
	public void admin_enters_data_missing_value_in_assignment_due_date_from_and_and_clicks_save_button_on_edit_assignment_page(
			String string, String string2) {
	}

	@Then("Assignment due date is missing for assignment page")
	public void assignment_due_date_is_missing_for_assignment_page() {
		
	}

	@When("Admin enters data missing value in grade by from {string} and {string}  and clicks save button on edit assignment page")
	public void admin_enters_data_missing_value_in_grade_by_from_and_and_clicks_save_button_on_edit_assignment_page(
			String string, String string2) {
		
	}

	@Then("Grade by is missing for assignment page")
	public void grade_by_is_missing_for_assignment_page() {
		
	}

	@When("Admin enters passed date in the due date field from {string} and {string} and clicks save button on edit assignment page")
	public void admin_enters_passed_date_in_the_due_date_field_from_and_and_clicks_save_button_on_edit_assignment_page(
			String string, String string2) {
		
	}

	@Then("Assignment cannot be updated for the passed date for assignment page")
	public void assignment_cannot_be_updated_for_the_passed_date_for_assignment_page() {
		
	}

	@Given("Admin is in  Edit assignment detail popup window  clicks Edit button in manage assignment")
	public void admin_is_in_edit_assignment_detail_popup_window_clicks_edit_button_in_manage_assignment() {
		
	}

	@When("Admin clicks Cancel button entering values in the fields on edit assignment page")
	public void admin_clicks_cancel_button_entering_values_in_the_fields_on_edit_assignment_page() {
...
//  Delete MultipleAssignment_validation
	...
	public void admin_is_in_delete_alert_for_assignment_page() {
		...
		assignmentPage.clickYesdeletealertassignment();
	...
	public void admin_clicks_no_button_for_delete_alert_assignment_page() {
		assignmentPage.clickNODelAlertAssgn();
	}
	...
	public void redirected_to_assignment_page_and_selected_assignment_details_are_not_deleted_from_the_data_table() {
		...
		assignmentPage.verifyAfterDeleteAssignment();
		LoggerLoad.info("selected assignment details are not deleted from the data table");
...
//  verifySort Function for Assignment
	...
	public void admin_should_see_data_table_sorted_in_descending_order() {
		...
		LoggerLoad.error("data table not sorted in descending order");
	...
	public void admin_should_see_data_table_sorted_in_ascending_order() {
		assignmentPage.validatingdataaftersortingbyAssNm();
		LoggerLoad.error("data table not sorted in ascending  order");
...
//  Pagination 
	...
	public void data_table_should_display_page_one_when_entries_available() {
		...
		Assert.assertEquals(currentPage, "RData table should display page one when entries available");
		LoggerLoad.error("Data table display page one is not present when entries available");
	...
	public void right_arrow_should_be_enabled_in_page_one_when_entries_are_more_than_five_available() {
		...
		Assert.assertEquals(fivePlusEntries,
				"Right arrow should be enabled in page one when entries are not more than five available");
		LoggerLoad.error("Right arrow not enabled in page one when entries are more than five available");
	...
	public void left_arrow_should_be_disabled_in_page_one_when_entries_are_more_than_five_available() {
		...
		Assert.assertEquals(lArrowDisables,
				"Right arrow should be enabled in page one when entries are not more than five available");
		LoggerLoad.error("Left arrow not disabled in page one when entries are more than five available");
	...
	public void right_arrow_should_be_enabled_in_page_two_when_entries_are_more_than_ten_available() {
		Boolean isRightArrowEnabled = assignmentPage.rightArrowWithTenEntr();

		assertTrue("Right arrow is not enabled on page two.", isRightArrowEnabled);
		LoggerLoad.error("Right arrow is not enabled in page two when entries are more than ten available");
	...
	public void when_entries_are_more_than_five_in_data_table_pagination_controls_enabled() {
		assignmentPage.PageOneWithfiveAndMoreDataEntries();
		LoggerLoad.error("delete icon below the header is disabled");
	...
	public void when_entries_are_less_than_five_in_data_table_pagination_controls_disabled() {
		assignmentPage.defaultPageOneWithDataEntries();
		LoggerLoad.error("No Pagination controls ");
	...
	public void admin_creates_less_than_or_equal_to_five_new_assignment_ds() {
		...
		LoggerLoad.error("Admin creates less new assignments");
	...
	public void when_total_class_entries_five_or_below_next_page_is_disabled() {
		...
		LoggerLoad.error("when total class entries five or below next page is not disabled");

	}

	@Then("Left arrow should be enabled in page two")
	public void left_arrow_should_be_enabled_in_page_two() {
		assignmentPage.PgOneLarrowDisabled();
		LoggerLoad.error("Left arrow not enabled in page two");
